...
open class YADLFullAssessmentStep: RKXSingleImageClassificationSurveyStep {
    ...
    open static func create(identifier: String, propertiesFileName: String) throws -> [YADLFullAssessmentStep]? {
    ...
    open static func create(identifier: String, json: AnyObject) -> [YADLFullAssessmentStep]? {
