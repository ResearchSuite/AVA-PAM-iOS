...
open class PAMMultipleSelectionStep: RKXMultipleImageSelectionSurveyStep {
    override open func stepViewControllerClass() -> AnyClass {
        return PAMMultipleSelectionStepViewController.self
    }
    
    open static func create(identifier: String, propertiesFileName: String, bundle: Bundle = Bundle.main) -> PAMMultipleSelectionStep? {
    ...
    open static func create(identifier: String, parameters: [String: Any], bundle: Bundle = Bundle.main) -> PAMMultipleSelectionStep? {
