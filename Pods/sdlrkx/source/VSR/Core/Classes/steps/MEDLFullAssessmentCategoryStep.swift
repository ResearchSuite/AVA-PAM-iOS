...
open class MEDLFullAssessmentCategoryStep: RKXMultipleImageSelectionSurveyStep {
    ...
    open static func create(identifier: String, propertiesFileName: String) throws -> [MEDLFullAssessmentCategoryStep]? {
    ...
    open static func create(identifier: String, json: AnyObject) -> [MEDLFullAssessmentCategoryStep]? {
