...
open class MEDLSpotAssessmentStep: RKXMultipleImageSelectionSurveyStep {
    ...
    open static func create(identifier: String, propertiesFileName: String, itemIdentifiers: [String]? = nil) throws -> MEDLSpotAssessmentStep? {
    ...
    open static func create(identifier: String, json: AnyObject, itemIdentifiers: [String]? = nil) -> MEDLSpotAssessmentStep? {
