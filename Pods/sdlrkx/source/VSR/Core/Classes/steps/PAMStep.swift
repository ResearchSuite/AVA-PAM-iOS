...
open class PAMStep: RKXMultipleImageSelectionSurveyStep {

    override open func stepViewControllerClass() -> AnyClass {
        return PAMStepViewController.self
    }
    
    open static func create(identifier: String, propertiesFileName: String = "PAM", bundle: Bundle = Bundle(for: PAMTask.self)) -> PAMStep? {
    ...
    open static func create(identifier: String, parameters: [String: Any], bundle: Bundle = Bundle(for: PAMTask.self)) -> PAMStep? {
