...
open class YADLSpotAssessmentStep: RKXMultipleImageSelectionSurveyStep {
    ...
    open static func create(identifier: String, propertiesFileName: String, itemIdentifiers: [String]? = nil) throws -> YADLSpotAssessmentStep? {
    ...
    open static func create(identifier: String, json: AnyObject, itemIdentifiers: [String]? = nil) -> YADLSpotAssessmentStep? {
