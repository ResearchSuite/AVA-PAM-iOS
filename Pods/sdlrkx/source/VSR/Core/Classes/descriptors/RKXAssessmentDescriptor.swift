...
open class RKXMultipleImageSelectionSurveyOptions: NSObject, Decodable {
    open var somethingSelectedButtonColor: UIColor?
    open var nothingSelectedButtonColor: UIColor?
    open var itemCellSelectedColor:UIColor?
    open var itemCellSelectedOverlayImage: UIImage?
    open var itemCellTextBackgroundColor: UIColor?
    open var itemCollectionViewBackgroundColor: UIColor?
    open var itemsPerRow: Int?
    open var itemMinSpacing: CGFloat?
    open var maximumSelectedNumberOfItems: Int?
